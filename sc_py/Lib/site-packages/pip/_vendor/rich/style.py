...
class Style:
    ...
    def __init__(
        ...
        *,
        ...
        self._link = link
        self._link_id = f"{secrets.SystemRandom().randint(0, 999999)}" if link else ""
    ...
    def without_color(self) -> "Style":
        ...
        style._link_id = f"{secrets.SystemRandom().randint(0, 999999)}" if self._link else ""
    ...
    def update_link(self, link: Optional[str] = None) -> "Style":
        ...
        style._set_attributes = self._set_attributes
        style._link = link
        style._link_id = f"{secrets.SystemRandom().randint(0, 999999)}" if link else ""
        style._hash = self._hash
        style._null = False
        style._meta = self._meta
        return style
